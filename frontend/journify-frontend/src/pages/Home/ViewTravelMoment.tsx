...
interface ViewTravelMomentsProps {
...
export default function ViewTravelMoment({
  onClose,
  momentInfo,
  onDeleteClick,
  onEditClick,
}: ViewTravelMomentsProps) {
  return (
      ...
      <div>
        <article className="flex-1 flex flex-col gap-2 py-4">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="inline-flex items-center gap-2 text-[13px] text-fuchsia-600 bg-fuchsia-200/40 rounded px-2 py-1">
